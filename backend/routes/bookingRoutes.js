...
import { createBooking, getMyBookings, getAllBookings, cancelBooking, getOccupiedTables, getWaitlistByRestaurant } from "../controllers/bookingController.js";
...
router.get("/occupied", asyncHandler(getOccupiedTables));
router.get("/waitlist/:restaurantId", asyncHandler(getWaitlistByRestaurant));
